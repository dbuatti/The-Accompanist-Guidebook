              ...
              <div key={level.id}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {level.modules.map((mod) => (
                    <div
                      key={mod.id}
                      className="group rounded-2xl border border-border/60 bg-card/50 hover:border-primary/20 hover:shadow-md hover:shadow-primary/[0.04] hover:-translate-y-0.5 transition-all duration-200 p-5"
                    >
